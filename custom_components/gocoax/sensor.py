...
SENSOR_DESCRIPTIONS: tuple[GoCoaxSensorEntityDescription, ...] = (
    ...
    GoCoaxSensorEntityDescription(
        key="tx_bad_packets",
        translation_key="tx_bad_packets",
        icon="mdi:upload-network-outline",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.packets.tx.bad,
    ),
    GoCoaxSensorEntityDescription(
        key="tx_dropped_packets",
        translation_key="tx_dropped_packets",
        icon="mdi:upload-network-outline",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.packets.tx.dropped,
    ),
    GoCoaxSensorEntityDescription(
        key="rx_bad_packets",
        translation_key="rx_bad_packets",
        icon="mdi:download-network-outline",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.packets.rx.bad,
    ),
    GoCoaxSensorEntityDescription(
        key="rx_dropped_packets",
        translation_key="rx_dropped_packets",
        icon="mdi:download-network-outline",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda data: data.packets.rx.dropped,
    ),
    GoCoaxSensorEntityDescription(
        key="peer_count",
